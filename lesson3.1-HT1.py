...
int_start = int(math.fabs(float(input('Введите начальное число: '))))
int_finish = int(math.fabs(float(input('Введите конечное число: '))))
...
for i in range(0, len(list_denom) - len(list_num), 1):
    list_num.append(0)
print(list_num)
